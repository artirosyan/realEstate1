        ...
        <div class="tm-row">
            ...
            <main class="tm-col-right">
                <section class="tm-content">
                    <H2 class="mb-5">DIAGOONA</H2>
                    <p>ԱՆՇԱՐԺ ԳՈՒՅՔԻ ԳՈՐԾԱԿԱԼՈՒԹՅՈՒՆ</p>
                    <hr class="mb-5">
                    <H4 class="mb-5">ՀԱՅՏԱՐԱՐՈՒԹՅՈՒՆ ԱՎԵԼԱՑՆԵԼՈՒ ՀԱՄԱՐ ԽՆԴՐՈՒՄ ԵՄ ԳՐԱՆՑՎԵԼ</H4>
                    <a href="contact" class="btn btn-primary">ԳՐԱՆՑՎԵԼ</a>
                </section>
            </main>
        </div>
    </div>
