        ...
        <div class="tm-row">
            ...
            <main class="tm-col-right">
                <section class="tm-content">
                    ...
                    <a href="index.jsp" >Go Home</a> | <a href="logout">Logout</a>


                    <h1> <%=home.getAddres()%> </h1>
                    <img src="getImage?picUrl=<%=home.getPicUrl()%>" width="200"/>
                    Author Name: <%=home.getPhoneNumber()%> <br>
                    price: <%=home.getPrice()%> <br>
                    Created Date: <%=home.getDescription()%> <br>
                    User name: <%=home.getUser().getName()%> <br>
                    User surname: <%=home.getUser().getSurname()%> <br>
